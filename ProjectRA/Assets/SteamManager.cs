...
public class SteamManager : MonoBehaviour
{
	...
	public List<Steamworks.CSteamID> GetFriendList()
	{
		...
		for (int i = 0; i < friendCount; i++)
		{
			...
			{
				string friendName = Steamworks.SteamFriends.GetFriendPersonaName((Steamworks.CSteamID)friend.m_SteamID);
				Debug.Log($"[steam friend info] steam id{friend.m_SteamID}, name{friendName}");
